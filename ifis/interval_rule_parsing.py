...
class IntervalClause(sf.Clause):
    """
    Class representing Interval Clause is extension of :class:'simpful.Clause'
    """
...
class IntervalFunctional(sf.Functional):
    """
    Class representing Interval Functional is extension of :class:'simpful.Functional'
    """
...
def AND(x, y):
    """
    Definition of basic AND aggregator in rules as Mean aggregation in case intervals and min function when input data
        are floats
    :param x: first aggregated value
    :type x: tuple, float
    :param y: second aggregated value
...
def AND_p(x, y):
    """
    Definition of basic AND aggregator in rules as Product aggregation in case intervals and product function when
...
def interval_recursive_parse(text, verbose=False, operators=None, allow_empty=True):
    ...
    :param verbose: toggles verbose mode
    :type verbose: bool
    :param operators: recognized in previous calling of function aggregation operator
    :type operators: str
    :param allow_empty: toggles allow empty clause
    :type allow_empty: bool
    :return: recognized part of function with aggregators
    :rtype: IntervalFunctional object
    """
